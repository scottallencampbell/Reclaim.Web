...
export class AdministratorClient extends ApiBase {
    ...
    */
    ...
    @param file (optional) 
    */
    upload(uniqueID: string, lastModifiedTimestamp?: moment.Moment | undefined, file?: FileParameter | null | undefined): Promise<Document> {
...
export class CustomerClient extends ApiBase {
    ...
    */
    ...
    ErrorCode.CustomerDoesNotExist
    ErrorCode.CustomerNotAssociatedToClaim
    ErrorCode.DocumentDoesNotExist
    ErrorCode.DocumentDownloadFromAzureFailed
    ...
    */
    upload(uniqueID: string, lastModifiedTimestamp?: moment.Moment | undefined, file?: FileParameter | null | undefined): Promise<Document> {
        let url_ = this.baseUrl + "/customer/claims/{uniqueID}/documents?";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        if (lastModifiedTimestamp === null)
...
export class InvestigatorClient extends ApiBase {
    ...
    */
    upload(uniqueID: string, lastModifiedTimestamp?: moment.Moment | undefined, file?: FileParameter | null | undefined): Promise<Document> {
        let url_ = this.baseUrl + "/investigator/claims/{uniqueID}/documents?";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        if (lastModifiedTimestamp === null)
...
export enum ErrorCode {
    ...
    CustomerNotAssociatedToClaim = "CustomerNotAssociatedToClaim",
