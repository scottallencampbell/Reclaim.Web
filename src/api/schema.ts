...
export class AdministratorClient extends ApiBase {
  ...
  getInvestigators(): Promise<Investigator[]> {
    ...
    return this.transformOptions(options_)
      .then((transformedOptions_) => {
        const res = this.http.fetch(url_, transformedOptions_)
        return res
      })
      .then((_response: Response) => {
  ...
  authenticated(): Promise<Account[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        const xxx = this.processAuthenticated(_response)
        return xxx
      })
  }
  ...
  init(_data?: any) {
    ...
    if (_data) {
      ...
      this.validUntil = _data['validUntil']
        ? new Date(_data['validUntil'].toString())
        : <any>undefined
  ...
  init(_data?: any) {
    ...
    if (_data) {
      ...
      this.authenticatedTimestamp = _data['authenticatedTimestamp']
        ? new Date(_data['authenticatedTimestamp'].toString())
        : <any>undefined
      this.sessionAuthenticatedTimestamp = _data['sessionAuthenticatedTimestamp']
        ? new Date(_data['sessionAuthenticatedTimestamp'].toString())
        : <any>undefined
      this.lastActiveTimestamp = _data['lastActiveTimestamp']
        ? new Date(_data['lastActiveTimestamp'].toString())
        : <any>undefined
      this.emailAddressConfirmedTimestamp = _data['emailAddressConfirmedTimestamp']
        ? new Date(_data['emailAddressConfirmedTimestamp'].toString())
        : <any>undefined
    }
  }
...
export class AdministratorDashboard extends Base implements IAdministratorDashboard {
  ...
  constructor(data?: IAdministratorDashboard) {
    ...
    if (data) {
      this.uniqueLogins =
        data.uniqueLogins && !(<any>data.uniqueLogins).toJSON
          ? new DashboardAggregate(data.uniqueLogins)
          : <DashboardAggregate>this.uniqueLogins
  ...
  init(_data?: any) {
    super.init(_data)
    if (_data) {
      this.uniqueLogins = _data['uniqueLogins']
        ? DashboardAggregate.fromJS(_data['uniqueLogins'])
        : new DashboardAggregate()
        ...
        for (let i = 0; i < data.attachments.length; i++) {
          ...
          this.attachments[i] =
            item && !(<any>item).toJSON
              ? new ClaimAttachment(item)
              : <ClaimAttachment>item
        }
      }
      this.policy =
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.originatedTimestamp = _data['originatedTimestamp']
        ? new Date(_data['originatedTimestamp'].toString())
        : <any>undefined
      ...
      this.summarizedTimestamp = _data['summarizedTimestamp']
        ? new Date(_data['summarizedTimestamp'].toString())
        : <any>undefined
      this.tombstonedTimestamp = _data['tombstonedTimestamp']
        ? new Date(_data['tombstonedTimestamp'].toString())
        : <any>undefined
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.bindingDate = _data['bindingDate']
        ? new Date(_data['bindingDate'].toString())
        : <any>undefined
  ...
  init(_data?: any) {
    ...
    if (_data) {
      ...
      this.nextEvent = _data['nextEvent']
        ? new Date(_data['nextEvent'].toString())
        : <any>undefined
    }
  }
